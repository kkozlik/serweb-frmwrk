...
if (isset($GLOBALS['controler'])){	
    $GLOBALS['controler']->add_reqired_javascript('core/functions.js');
    $GLOBALS['controler']->add_reqired_javascript('core/get_js.php?mod=growable_forms&js=growable_forms.js');
}
