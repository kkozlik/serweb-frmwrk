...
/* An identification string that will be included in all log events logged.
 */
$config->log_ident = "serweb";
...
/* Another options for the logger. The allowed options depends on the used
   logging handler (set by $config->log_file). For details see `configuration`
   for selected logger handler on http://pear.github.io/Log/
 */
$config->log_options = [];
